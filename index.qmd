...
::: {.shock-subtitle}
Dashboards signal failure here. The better question is: what happened to backlog age, and to the exposure from aging open work?
:::
::::
...
::: {.kicker}
We were finally closing the older backlog.
:::
...
::: {.incremental}
- Longer-open vulnerabilities usually create more exposure over time
- Long-lived backlog usually increases uncertainty and attack surface
- Reducing backlog age usually reduces accumulated exposure
:::

::: {.kicker}
Backlog age is not just time. Aging open work usually increases exposure.

Once closed work and open work are separated, exposure is much easier to review.
:::
...
(
    ...
    + labs(
        ...
        subtitle="Newest-First leaves most of the old backlog in place.",
        x="Month",
...
::: {.centered .muted}
This is the tail that gets stranded.
:::
...
- It shows how quickly closed work gets resolved
...
- Exposure usually drops even though the headline metric looks worse
:::
...
::: {.incremental}
- MTTR up + MOVA down = the older backlog is getting cleared
- MTTR down + MOVA up = recent closures look better while backlog age worsens
- Across teams, MTTR up can mean effort shifted to the older backlog
