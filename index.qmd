...
::: {.kicker .centered}
MTTR is always bounded by a time window. Label it before calling a regression.
:::
...
::: {.centered .muted}
MTTR and MOVA show the consequences of your prioritization.

They should not drive the queue.
:::
