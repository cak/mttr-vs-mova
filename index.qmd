...
::: {.shock-subtitle}
Dashboards signal failure here. The better question is: what happened to backlog age, and the exposure from aging open work?
:::
::::
...
::: {.kicker}
We were finally closing the oldest backlog.
:::
...
Once closed and open work are separated, backlog age and exposure are easier to review.
:::
