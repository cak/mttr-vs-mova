...
- The oldest findings usually tell the real story
:::
...
::: {.centered .muted}
On backlog age, Oldest-First is healthier.
:::
...
## Same data, wrong winner {.statement-slide .table-slide}
...
::: {.line-anchor .line-anchor-subtle .centered}
If you read only MTTR, you pick the wrong winner.
:::
...
::: {.line-anchor .centered .blood-line}
MTTR is useful. The mistake is letting it decide alone.
:::
...
::: {.centered .muted}
If this is the only KPI, the system rewards closing recent work first.
:::
...
::: {.centered .muted}
MTTR matters. It cannot stand alone.
:::
...
Read them together or you reward the wrong behavior.
:::
...
:::
### Open count + 180+
Add count and a threshold such as 180+ days.
:::
...
:::
### Read together
Review MTTR with backlog age and the 180+ tail visible.
:::
