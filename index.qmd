...
Older vulnerabilities often persist because they are harder to fix, require coordination, or carry more risk.
:::
...
MTTR can make recent closure activity look like broad progress.
:::
...
::: {.centered .muted}
MOVA reveals what remains open.

It shows the age consequences of what remains unresolved.
:::

---

## End state: MOVA reveals what remains open
...
::: {.dashboard-grid}
::: {.dashboard-card .dashboard-card-emphasis}
::: {.dashboard-title}
Newest-First
:::
::: {.dashboard-value}
...
::: {.centered .muted}
If this is the only KPI, recent closures can look like broad progress.
:::
...
:::
### Track MTTR + MOVA
Use them to verify the consequences of risk-based prioritization.
:::
...
Metrics stay observational. Prioritization stays risk-based.
:::
:::
...
::: {.centered .muted}
MTTR and MOVA are complementary partial signals. Read the system, not just the metric.
:::
