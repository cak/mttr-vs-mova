...
The next question is: did we slow down, or did we change what we fixed?
...
::: {.line-anchor}
MTTR increased after we formalized vulnerability management.
:::
...
- Dashboard read: vulnerability management had regressed
:::

::: {.kicker}
MTTR rose because we were finally closing older findings from the backlog.
:::
...
We needed a way to measure the open backlog today, not just what closed.
:::
...
:::
### MTTR
Mean Time to Remediate. How fast are we closing work?
...
:::
### MOVA
Mean Open Vulnerability Age. How old is the open backlog today?
...
::: {.kicker}
Backlog age today. Current age of open vulnerabilities.
:::
...
::: {.definition-card}
### Backlog age
How long that open work has been sitting
:::

::: {.definition-card}
### Exposure
Aging open work usually increases exposure over time.
:::
:::

::: {.compact-list}
- MTTR and MOVA use the same source data
- Backlog age starts at the created date
...
::: {.centered .muted}
Under Newest-First, the oldest open work barely moves.
:::
...
::: {.incremental}
- MTTR up + MOVA down = older open work is getting cleared
- MTTR down + MOVA up = recent closures look better while backlog age worsens
- MTTR up can mean effort shifted to older open work
...
:::
### Track MTTR + MOVA
Prioritize the oldest open work first.
:::
