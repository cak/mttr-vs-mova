...
::: {.shock-subtitle}
Dashboards signal failure here. The better question is: what happened to backlog age, and to the oldest open work?
:::
::::
...
- MTTR up can mean effort shifted to the older backlog
...
The real work is defining the metric in code before it reaches a dashboard.
:::
...
:::
### Track MTTR + MOVA
Prioritize the oldest backlog first.
:::
