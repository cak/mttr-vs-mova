...
What happened to backlog age, and to the oldest part of the backlog?
:::
::::
...
We needed to measure the risk still open, not just what closed.
:::
...
:::
::: {.tail-text}
The oldest backlog is not moving.
:::
:::
:::
...
::: {.kicker}
Backlog age today. The age of what is still open.
:::
...
::: {.definition-card}
### Backlog age
How long the backlog has been sitting
:::

::: {.definition-card}
### Exposure
Aging backlog usually increases exposure over time.
:::
:::
...
::: {.incremental}
- MTTR up + MOVA down = older backlog is getting cleared
- MTTR down + MOVA up = recent closures look better while backlog age worsens
- MTTR up can mean effort shifted to older backlog
...
:::
### Track MTTR + MOVA
Prioritize older backlog first.
:::
