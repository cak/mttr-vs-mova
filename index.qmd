...
Oldest-First changes MOVA in the simulation, but it ignores risk and is not a real-world strategy.
...
```{python}
#| echo: false
#| fig-alt: "Line chart of MOVA over time under two prioritization strategies. It shows how old open work is under each strategy."
...
::: {.centered .muted}
MOVA shows how old open work is.
:::

---

## End state: MOVA shows the difference
...
::: {.centered .muted}
End-state MOVA does not replace MTTR. It complements it.
:::
...
(
    ...
    .tab_header(
        ...
        subtitle="MTTR reflects flow. MOVA reflects backlog age. They are complementary partial signals.",
    )
...
::: {.centered .muted}
The fuller view keeps MTTR and MOVA together.
:::
...
:::
::: {.score-label}
New work closes while backlog ages
:::
:::
...
:::
### Flow + backlog age
MTTR is flow. MOVA is backlog age.
:::
...
::: {.centered .muted}
MTTR and MOVA are complementary partial signals. Use them to observe the system, not optimize directly.
:::
