...
def strategy_line_plot(
    ...
    label_data = endpoints.with_columns(pl.col("strategy_label").alias("label"))
    highlighted_labels = label_data.filter(
        pl.col("strategy_label") == highlighted_strategy
    )
    comparison_labels = label_data.filter(
        pl.col("strategy_label") != highlighted_strategy
    )
