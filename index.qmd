...
We needed to measure how old the open backlog is today, not just what closed.
:::
...
::: {.definition-card}
### Backlog age
How long open findings have been sitting
:::

::: {.definition-card}
### Exposure
Older backlog usually increases risk over time.
:::
:::

::: {.compact-list}
- MTTR and MOVA use the same data
- For open findings, age starts at the created date
...
Keep arrivals, remediation capacity, and time horizon fixed.
:::
